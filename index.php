...
<body>
   ...
   <div class="container-fluid">
      <div class="row" style="margin-top: 4%">
         ...
         <div class="col-md-7">
            <h4 class="widget-title mb-4">Destaque De <span> Hoje</span></h4>
            <!-- Blog Post -->
            <div class="row">
               <?php
               ...
               ?>
                  <div class="col-md-6">
                     <div class="card mb-4 border-0">
                        <img class="card-img-top" src="0/postimages/<?php echo htmlentities($row['PostImage']); ?>" alt="<?php echo htmlentities($row['posttitle']); ?>" height="200px">
                        <div class="card-body">
                           <p class="m-0">
                              <!--category-->
                           ...
                           <p class="m-0"><small> Postado em <?php echo htmlentities($row['postingdate']); ?></small></p>
                  ...
                  <!-- <ul class="pagination justify-content-center mb-4">
                        ...
                        <li class="<?php if ($pageno >= $total_pages) {
                           ...
                           <a href="<?php if ($pageno >= $total_pages) {
                                       ...
                                       echo "?pageno=" . ($pageno + 1);
                                    } ?> " class="page-link border-0">Seguinte</a>
                        </li>
