...
if (isset($_POST['submit'])) {
   ...
   if (!empty($_POST['csrftoken'])) {
      if (hash_equals($_SESSION['token'], $_POST['csrftoken'])) {
         ...
         if ($query) :
            echo "<script>alert('Comentário enviado com sucesso. O comentário será exibido após revisão do administrador');</script>";
   ...
   <div class="container-fluid">
            ...
            ?>
               <div class="card border-0">
                  <div class="card-body">
                     ...
                     <p>
                     por <?php echo htmlentities($row['postedBy']); ?> em : <?php echo htmlentities($row['postingdate']); ?>
                        <?php if ($row['lastUpdatedBy'] != '') : ?>
                           Última atualização por <?php echo htmlentities($row['lastUpdatedBy']); ?><?php echo htmlentities($row['UpdationDate']); ?>
                     </p>
                  <?php endif; ?>
                  ...
                  <hr>
                  <img class="img-fluid w-100" src="0/postimages/<?php echo htmlentities($row['PostImage']); ?>" alt="<?php echo htmlentities($row['posttitle']); ?>">
            ...
            <div class="media mb-4">
               ...
               <div class="media-body">
                  <h5 class="mt-0"><?php echo htmlentities($row['name']); ?> <br />
                     <span style="font-size:11px;"><b>Em</b> <?php echo htmlentities($row['postingDate']); ?></span>
                  </h5>
      ...
      <div class="col-md-8">
         ...
         <div class="card my-4 bg-transparent border-0">
            <h5 class="card-header bg-transparent border-0">Deixe um comentário</h5>
            <div class="card-body">
               <form name="Comment" method="post">
                  <input type="hidden" name="csrftoken" value="<?php echo htmlentities($_SESSION['token']); ?>" />
                  <div class="form-group">
                     <input type="text" name="name" class="form-control rounded-0" placeholder="Escreva seu nome completo" required>
                  </div>
                  <div class="form-group">
                     <input type="email" name="email" class="form-control rounded-0" placeholder="Digite seu e-mail válido" required>
                  </div>
                  <div class="form-group">
                     <textarea class="form-control rounded-0" name="comment" rows="3" placeholder="Comentário...." required></textarea>
                  </div>
